...
const targetProductSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 2.1 },
});

// Create a model based on the schema for Target product
const ProductModel = mongoose.model('Product2', targetProductSchema);

const targetUrl = 'https://www.target.com/p/msi-raider-ge68hx-16-144hz-miniled-uhd-gaming-laptop-intel-core-i9-14900hx-nvidia-rtx-4070-32gb-ddr5-2tb-ssd-win-11-home-black-14vgg-247us/-/A-91125237#lnk=sametab';
