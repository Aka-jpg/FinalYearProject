...
const targetProductSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 2.4 },
});

// Create a model based on the schema for Target product
const ProductModel = mongoose.model('Product2', targetProductSchema);

const targetUrl = 'https://www.target.com/p/acer-aspire-vero-15-6-laptop-intel-core-i7-1355u-1-70ghz-16gb-512gb-ssd-w11h-manufacturer-refurbished/-/A-91091747#lnk=sametab';
