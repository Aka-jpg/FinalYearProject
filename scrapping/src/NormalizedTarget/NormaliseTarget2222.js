...
const targetProductSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 2.3 },
});

// Create a model based on the schema for Target product
const ProductModel = mongoose.model('Product2', targetProductSchema);

const targetUrl = 'https://www.target.com/p/asus-rog-strix-g17-2023-gaming-laptop-17-3-qhd-240hz-geforce-rtx-4070-amd-ryzen-9-7945hx-16gb-ddr5-1tb-pcie-ssd-wi-fi-6e-windows-11/-/A-89283653#lnk=sametab';
