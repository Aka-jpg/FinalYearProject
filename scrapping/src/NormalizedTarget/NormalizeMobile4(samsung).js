  ...
  const targetProductSchema = new mongoose.Schema({
    ...
    rating: { type: Number, default: 24 }
  });
  
  // Create a model based on the schema for Target product
  const ProductModel = mongoose.model("Product2", targetProductSchema);
  const targetUrl =
  "https://www.target.com/p/manufacturer-refurbished-samsung-galaxy-s20-5g-g981u-verizon-unlocked-128gb-cosmic-gray-excellent/-/A-90516746#lnk=sametab";
