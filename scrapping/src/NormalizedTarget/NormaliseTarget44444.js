...
const targetProductSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 2.2 },
});

// Create a model based on the schema for Target product
const ProductModel = mongoose.model('Product2', targetProductSchema);

const targetUrl = 'https://www.target.com/p/msi-stealth-gs77-17-3-qhd-240hz-ultra-thin-and-light-gaming-laptop-intel-core-i7-12700h-rtx3080ti-32gbddr5-1tb-nvme-ssd-win11pro-12uhs-083/-/A-86284733#lnk=sametab';
