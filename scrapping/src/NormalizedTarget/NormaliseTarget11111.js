...
const targetProductSchema = new mongoose.Schema({
  ...
  image: String,
  rating: { type: Number, default: 2.8 },
});
...
const targetUrl =
  "https://www.target.com/p/hp-victus-15-6-full-hd-gaming-laptop-amd-ryzen-5-7535hs-8gb-ram-512gb-ssd-nvidia-geforce-rtx-2050-windows-11-home/-/A-89927312#lnk=sametab";
...
async function getTargetProductData() {
  try {
    ...
    const description = $("div[data-test='item-details-description']")
      .text()
      .trim();
    ...
    console.log(
      "Data saved to Target collection in MongoDB database:",
      newTargetProduct.toObject()
    );
  } catch (error) {
